-- ═══════════════════════════════════════════════════════════════
-- HỆ THỐNG QUẢN LÝ THƯ VIỆN ĐẠI HỌC (Phiên bản PostgreSQL)
-- File: database_postgres.sql
-- Chạy file này trong PostgreSQL (Render) để khởi tạo toàn bộ CSDL
-- ═══════════════════════════════════════════════════════════════

-- Xóa các bảng cũ nếu tồn tại (theo thứ tự ràng buộc khóa ngoại)
DROP TABLE IF EXISTS CHUA CASCADE;
DROP TABLE IF EXISTS PHIEUMUON CASCADE;
DROP TABLE IF EXISTS TAILIEU CASCADE;
